...
class Window1:
    def __init__(self, master):
        ...
        self.LabelTitle=Label(self.frame,text='Pharmacy Managemnt System',font=('arial',50,'bold'),bd=20)
    ...
    #============================================================================================================= 
        self.lblUsename=Label(self.Loginframe1,text='Username',font=('arial',30,'bold'),bd=22)
    ...
    #====================================================================================================================    
        ...
        self.btnRegistration=Button(self.Loginframe3, text='Patients Registration Systems',state=DISABLED, command=self.Registration_window,font=('arial',20,'bold'))
        self.btnRegistration.grid(row=0,column=0)
        self.btnHospital=Button(self.Loginframe3,text='Hospital Management Systems',state=DISABLED,command=self.Hospital_window,font=('arial',20,'bold'))
...
#=======================================================================================================
        ...
        #===============================Function Declared==============================================
        def iExit():
            iExit=tkinter.messagebox.askyesno("Patients Registration Systems","Confirm if you want to exit")
            if iExit > 0:
                #root.destroy()
                self.master.destroy()
                return
        ...
        def iResetRecord():
            iResetRecord = tkinter.messagebox.askokcancel("Patients Registration Systems",'Confirm if you want to add a record')
            if iResetRecord > 0:
                Reset()
            elif iResetRecord <= 0:
                Reset()
     ...
     #================================Frame=====================================================================
        ...
        self.lblTitle=Label(TitleFrame,font=('arial',59,'bold'),text='Patient Registration Systems',padx=4)
        self.lblTitle.grid()
    #================================lowerframes=================================================================
    ...
    #===============================================================================================================    
        ...
        self.lblFirstname=Label(MembersName_F,font=('arial',14,'bold'),text='Fisrtname',bd=7)
...
#========================= Member Information======================================================================
        ...
        self.cboProve_of_ID['value']=('','Pilot Licence','Driving Licence','Passport','Student_ID')
        self.cboProve_of_ID.current(0)
...
#=========================receipt===========================================================================
        self.lblLabel=Label(Receipt_ButtonFrame,font=('arail',10,'bold'),pady=10,
                            text="Patient Ref\t Fisrtname\t Surname\t Address\t\t Date Reg.\t Telephone\t Patient Paid",bd=7)
...
class Window3:
    def __init__(self, master):
        ...
        def iPrescription():
            ...
            self.txtPrescription.insert(END, 'Storage Advise: \t\t\t\t' + StorageAdvice.get() + "\n")
            self.txtPrescription.insert(END, 'Driving of Using Machines: \t\t\t\t' +  DrivingUsingMachines.get() + "\n")
        ...
        def iPrescriptionData():
            self.txtFrameDetail.insert(END, cmbNameTablets.get()+"\t\t"+ Ref.get()+"\t"+ Dose.get()+"\t\t"+ NumberTablets.get() +"\t"+ Lot.get()+ "\t"+ IssueDate.get() +"\t\t"+ ExpDate.get() +"\t"+ DailyDose.get() +"\t\t"+  StorageAdvice.get() + "\t"+ NHSNumber.get() + "\t\t"+ PatientName.get() +"\t"+ DateofBirth.get() +"\t"+ PatientAddress.get() + "\n")
   ...
   #===============================Frame=========================================================================     
        ...
        FrameDetail=Frame(MainFrame, bd=20, width=1530, height=100,padx=20, relief=RIDGE)
        FrameDetail.pack(side=BOTTOM)
        
        ButtonFrame=Frame(MainFrame, bd=20, width=1530, height=50,padx=20, relief=RIDGE)
        ButtonFrame.pack(side=BOTTOM)
        
        DataFrame=Frame(MainFrame, bd=20, width=1530, height=400,padx=20, relief=RIDGE)
        DataFrame.pack(side=BOTTOM)
        
        DataFrameLEFT=LabelFrame(DataFrame, bd=10, width=800, height=400,padx=20, relief=RIDGE)
  ...
  #==============================================DataFrameLEFT==================================================================
        ...
        self.cboNameTablet=ttk.Combobox(DataFrameLEFT, textvariable=cmbNameTablets, state='readonly',font=('arail',12,'bold'),width=20)
 ...
 #===========================================ButtonFrame=======================================================================
        ...
        self.btnPrescription.grid(row=0, column=0,sticky=W)
...
#===================================================Frame Detail==========================================
        ...
        self.txtFrameDetail=Text(FrameDetail, font=('arial', 12, 'bold') , width =141, height=4, padx=2)
